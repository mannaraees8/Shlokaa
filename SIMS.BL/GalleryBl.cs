...
namespace SIMS.BL
{
    public class GalleryBl
    {
        ...
        public GalleryBl(int id, string FileName, string FileData, string Thumbnail, string FileType, string Title, bool isdeleted)
        {
            _id = id;
            _fileName = FileName;
            _fileData = FileData;
        ...
        public GalleryBl(int id, string FileName, string Thumbnail, string FileType, string Title, bool isdeleted)
        {
            _id = id;
            _fileName = FileName;
            _thumbnail = Thumbnail;
        ...
        public GalleryBl(string FileData)
        {
        ...
        public static List<GalleryBl> RetrieveAll()
        {
            List<GalleryBl> galleryList = new List<GalleryBl>();
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    while (r.Read())
                    {
                        galleryList.Add(new GalleryBl(Convert.ToInt32(r["Id"])
        ...
        public static List<GalleryBl> RetrieveWithoutFileData()
        {
            List<GalleryBl> galleryList = new List<GalleryBl>();
            try
            {
        ...
        public static GalleryBl RetrieveById(int Id)
        {
            GalleryBl result = null;
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    if (r.Read())
                    {
                        result = new GalleryBl(Convert.ToInt32(r["Id"])
                            , Convert.ToString(r["FileName"].ToString())
